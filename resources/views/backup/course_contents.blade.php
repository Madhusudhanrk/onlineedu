							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="general_knowledgebase.html">Knowledgebase</a></li>
										<li>
											<a href="#">Blog</a>
											<ul>
				...
				{{-- <div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">General Pages</span> - Knowledgebase</h4>

							<ul class="breadcrumb position-right">
								<li><a href="index.html">Home</a></li>
								<li><a href="general_knowledgebase.html">General pages</a></li>
							...
							<div class="col-md-4">
								<div class="panel">
									<div class="panel-body text-center">
										...
										<a href="{{url('storage/course_files/'.$list->course_path)}} " target="_blank" class="btn bg-success-400">Learn</a>
									</div>
								</div>
							</div>
							@endforeach
