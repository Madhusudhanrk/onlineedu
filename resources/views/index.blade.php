    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="slider-active">
                <!-- Single Slider -->
                <div style="background-color:#BCDEFE" class="single-slider slider-height d-flex align-items-center">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    ...
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="courses" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Get Started</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                ...
                                <p>App Development is the creation of computer applications for use on mobile devices.</p>
                                {{-- <a  href="#" class="read-more1">Read More ></a> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                ...
                                <p>Video editing is the manipulation,structure and present all video information of video shots.</p>
                                {{-- <a  href="#" class="read-more1">Read More ></a> --}}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                ...
                                <p>A language is a structured system of communication with different Religion Humans.</p>
                                {{-- <a  href="#" class="read-more1">Read More ></a> --}}
                            </div>
                        </div>
                    </div>
        ...
        <!-- Popular Course End -->
        <!--? Team Ara Start -->
        {{-- <div style="background-color:#2D3092" class="team-area pt-160 pb-160 section-bg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        <!-- Section Tittle -->
        ...
        <!-- About Law End-->
        <!--? Testimonial Start -->
        <div class="testimonial-area fix pt-180 pb-180 section-bg" style="background-color:#2D3092">
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial pt-65">
                                ...
                                <div class="testimonial-icon mb-45">
                                    <img src="assets/img/gallery/quote.png" class="ani-btn " alt="">
                                </div>
                                    <!-- Testimonial Content -->
