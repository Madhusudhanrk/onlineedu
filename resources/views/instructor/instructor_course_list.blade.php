...
<head>
	...
	<script>
		function deleteCourse(id){
			// alert(id);
			if(confirm("Course Will be Removed!")){
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"><a href="{{url('index')}}">Home</a></span> - Your Courses</h4>
						</div>
				...
				@if(Session::has('update-course-status'))
				<p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('update-course-status') }}
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Courses table</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-basic">
							...
							<tbody>
								...
								<tr id="crid{{$list->id}}">
									...
									<td><span class="label label-success">PDF</span></td>
									<td class="text-center">
										<ul class="icons-list">
											<li class="dropdown">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li onclick="deleteCourse({{ $list->id }})"><a><i class="icon-cross"></i>Remove</a></li>
													
													<li><a href="{{url('update_course/'.$list->id)}} "><i class="icon-pencil"></i>Update</a></li>											  
