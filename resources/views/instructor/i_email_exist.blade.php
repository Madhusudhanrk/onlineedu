		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<!-- Password recovery -->
					@if(session()->has('forgot-status'))
							  <p class="alert {{ session()->get('alert-class', 'alert-info') }}">{{ session()->get('forgot-status') }}
					...
					@endif
					{{-- form started --}}
					<form action="{{url('i_forgot-password')}}" method="POST">
						...
						<div class="panel panel-body login-form">
							...
							<div class="form-group has-feedback">
								<input type="email" name="instructor_email" class="form-control" placeholder="Your email">
