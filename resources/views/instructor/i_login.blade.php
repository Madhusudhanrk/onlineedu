	...
	<div class="limiter">
		<div class="container-login100" style="background-color: #2D3092">
			...
			@endif
				...
				<form action="dologin_instru" method="post" class="login100-form validate-form flex-sb flex-w">
					{{ csrf_field() }}
					...
					<div class="wrap-input100 validate-input" data-validate = "Username is required">
						<input class="input100" type="text" name="instructor_email" >
					...
					<div class="p-t-13 p-b-9">
						...
						<a href="{{url('i_email_exist')}}" class="txt2 bo1 m-l-5">
							Forgot?
						</a>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="instructor_password" >
						<span class="focus-input100"></span>
					</div>
					...
					<div class="w-full text-center p-t-55">
						...
						<a href="{{url('regi_instru')}}" class="txt2 bo1">
							Sign up now
						</a>
					</div>
				</form>
