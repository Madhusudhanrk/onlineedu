    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-user">
            <div class="category-content">
                <div class="media">
                    <a href="#" class="media-left"><img src="{{asset('global_assets/images/placeholders/placeholder.jpg')}}" class="img-circle img-sm" alt=""></a>
                    <div class="media-body">
                       ...
                       @endphp
                        <span class="media-heading text-semibold">{{$instructor_name}}</span>
                        <div class="text-size-mini text-muted">
                            <i class="icon-pin text-size-small"></i> &nbsp;Bangalore
                        </div>
                    </div>
        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    {{-- <li class=" "><a href="admin_dashboard"><i class="icon-home4"></i> <span>Dashboard</span></a></li> --}}

                    <li class=" "><a href="{{ url('create_course') }}"><i class="icon-book"></i> <span>Create Course</span></a></li>

                    <li class=" "><a href="{{ url('i_course_list') }}"><i class="icon-list"></i> <span>Your Courses</span></a></li>

                    {{-- <li class=" "><a href="admin_list"><i class="icon-lock"></i> <span>Admins</span></a></li> --}}
                    {{-- <li>
