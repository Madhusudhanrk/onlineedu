				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <a href="{{url('index')}}"><span class="text-semibold">Home</span></a> - Users</h4>
						</div>
									...
									<td class="text-center">
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li onclick="deleteCourse({{ $user->id }})"><a><i class="icon-cross"></i>Remove</a></li>
