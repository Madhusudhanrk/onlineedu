				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"><a href="{{url('index')}}">Home</a></span> - Admin</h4>
						</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Admins datatable</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<table class="table datatable-basic">
							...
							<tbody>
								...
								<tr id="alid{{$admin->id}}">
									...
									{{-- <td>{{date('d-m-Y/ h:i', strtotime($admin->updated_at))}}</td>								  --}}
									...
									<td class="text-center">
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li onclick="deleteCourse({{ $admin->id }})"><a><i class="icon-cross"></i>Remove</a></li>
													{{-- <li><a href="#"><i class="icon-file-pdf"></i> Export to .pdf</a></li>
													<li><a href="#"><i class="icon-file-excel"></i> Export to .csv</a></li>
													<li><a href="#"><i class="icon-file-word"></i> Export to .doc</a></li> --}}
												</ul>
						...
						@else
						  ...
						  @endphp
							<div class="alert alert-danger" role="alert">
									U don't Have Any Admins, Please SignUp
