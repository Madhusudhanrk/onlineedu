                ...
                <div class="media">
                    ...
                    @php
                     if(session()->has('admin_login_id_set')){           
                        $admin_id = session()->get('admin_login_id_set');
                        $admin_id = explode('@',$admin_id);
                      }   
                    @endphp
                     
                        <span class="media-heading text-semibold">{{$admin_id[0]}}</span>
                        <div class="text-size-mini text-muted">
                            <i class="icon-pin text-size-small"></i> &nbsp;Bangalore Kormangala
                        </div>
                    </div>
        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li class=" "><a href="{{url('admin_dashboard')}}"><i class="icon-home4"></i> <span>Dashboard</span></a></li>

                    <li class=" "><a href="{{url('admin_user_list')}}"><i class="icon-user"></i> <span>Users</span></a></li>

                    <li class=" "><a href="{{url('admin_instructor_list')}}"><i class="icon-book"></i> <span>Instructors</span></a></li>

                    <li class=" "><a href="{{url('admin_list')}}"><i class="icon-lock"></i> <span>Admins</span></a></li>

                    <li class=" "><a href="{{url('admin_feedback_list')}}"><i class="icon-user"></i> <span>Feedback</span></a></li>
                    {{-- <li>
