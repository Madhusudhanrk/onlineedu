	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="{{url('index')}}">
				...
				<span style="color:wight;font-size:17px;">Admin Login</span>
			</a>
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				@endif
					<!-- Simple login form -->
					<form action="{{url('doadmin_login')}}" method="POST">
					{{ csrf_field() }}
						...
						<div class="panel panel-body login-form">
							...
							<div class="form-group has-feedback has-feedback-left">
								<input type="text" name="admin_email" class="form-control" placeholder="Email ID" required>
							...
							<div class="form-group">
								<button type="submit" class="btn btn-primary btn-block">Sign in <i class="icon-circle-right2 position-right"></i></button><br>
								<span class="txt2">
									Not a member? 
								</span>
								<a href="admin_register" class="txt2 bo1">
									Sign up now
								</a>
							</div>

							<div class="text-center">
							<a href="{{url('a_email_exist')}}">Forgot password?</a>
							</div>
						</div>
					</form>
					<!-- /simple login form -->
